...
<body>
    ...
    <main class="articles-section">
        <h2><?php echo urlencode($news_item['category']); ?></h2><br><br>
        <?php
        include 'config.php'; // Include the database connection
        $result = $conn->query("SELECT * FROM news WHERE archive = 0 and category = 'Svijet' ORDER BY created_at");
